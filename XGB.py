# -*- coding: utf-8 -*-
"""
Created on Thu Aug  1 21:09:18 2024
...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  1 20:25:52 2024
...
# Bootstrap
num_resamples =100  # Number of resampling iterations
all_weighted_f1_scores = []  
count=0
for resample_index in range(num_resamples):
    X_resampled, Y_resampled = resample(X, Y, replace=True, random_state=resample_index)
    ...
    weighted_f1 = f1_score(Y_resampled, y_pred_array, average='weighted')
    all_weighted_f1_scores.append(weighted_f1)
